...
output "_3_ids_iap_ssh_attacker_server" {
  value = "gcloud compute ssh --zone ${var.subnetwork_region}-b ${google_compute_instance.ids_demo_attacker_machine.name}  --tunnel-through-iap --project ${var.demo_project_id}"
}
